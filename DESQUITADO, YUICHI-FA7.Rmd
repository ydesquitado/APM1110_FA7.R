...
For the second point, the plot has shown that the curve is illustrated at the first quadrant in any points within the bounds $[2,6]$, thus $f(x)$ is non-negative (or greater than or equal to 0)
